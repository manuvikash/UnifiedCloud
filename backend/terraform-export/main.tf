...
# Application Load Balancer (Component 0)
...
# RDS Postgres Instance (Component 2)
...
resource "aws_s3_bucket" "static_website" {
  bucket = "${var.app_name}-${var.environment}-static-website-${random_id.bucket_suffix.hex}"

  tags = {
    Name = "${var.app_name}-${var.environment}-static-website"
  }
}
...
# CloudFront Distribution (Component 4)
